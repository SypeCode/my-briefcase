...
const Skills = () => {
    return (
        <section id="skills" class="animado" >
            <div id="skills__container" className="container-fluid shadow bg-body rounded h-100">
                <div className="row pt-4 border border-bottom-3">
                    <div className="col-12 p-4">
                        <h3 id="about__container--name" className="font-weight-bold ml-4">Habilidades Técnicas</h3>
                    </div>
                </div>
                <div className="row p-5">
                    <div className="col-lg-8 col-sm-12 p-4 border d-flex flex-column align-items-center">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <h4 className="font-weight-bold text-center mb-5">Aptitudes</h4>
                    ...
                    <div className="col-lg-4 col-sm-12 p-4 border d-flex flex-column align-items-center">
                        ...
                        <h4 className="font-weight-bold text-center mb-5">Idiomas</h4>
                    ...
                    <div className="col-12 p-4 border d-flex lign-items-center">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <h4 className="font-weight-bold text-center mb-5">Tecnologias</h4>
                            ...
                            <div class="col-lg-4 col-sm-12">
                                <h4 className="font-weight-bold text-center mb-5">frameworks y más</h4>
