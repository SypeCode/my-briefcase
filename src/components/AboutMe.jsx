...
const AboutMe = () => {
    return (
        <>
            <section id="about">
                <div id="about__container" className="container-fluid shadow bg-body rounded h-100 pl-4 pr-5">
                    <div className="row pt-4 border border-bottom-3">
                        <div className="col-12 p-4">
                            <h3 id="about__container--section" className="font-weight-bold ml-3">Acerca de mí</h3>
                        </div>
                    </div>
                    <div className="row pb-4">
                        ...
                        <div className="col-lg-8 col-sm-12 p-4">
                            ...
                            realice mis prácticas profesionales y capacitación como Desarrollador
                                    Web dentro de la empresa <a id="enlace" href="https://orbitweb.ca/">OrbitWeb Inc</a>.
